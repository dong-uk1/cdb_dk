...
<body>
	...
	<table class="table">
		...
		<c:forEach items="${list}" var="vo">
			<tbody>
				<tr>
					<td><c:out value="${vo.br_suplytype}" /></td>
					<td id="brtc">${vo.br_brtc}</td>
					<td  class="signgu"><c:out value="${vo.br_signgu}"/></td>
					<!-- 지도로 보기 -->
					<td><c:out value="${vo.br_fulladdr}" /><button class='btn' value="${vo.br_fulladdr}">지도로 보기</button></td>
					...
					<td><fmt:formatDate value="${vo.br_beginde}" pattern="yyyy-MM-dd" /></td>
					<td><fmt:formatDate value="${vo.br_winannde}" pattern="yyyy-MM-dd" /></td>
				</tr>
			</tbody>
		</c:forEach>
	</table>
